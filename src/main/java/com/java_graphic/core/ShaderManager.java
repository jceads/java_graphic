...
public class ShaderManager {
    ...
    public int createShader(String shaderCode, int shaderType) throws Exception {
        ...
        if (GL20.glGetShaderi(shaderID, GL20.GL_COMPILE_STATUS) == 200)
            throw new Exception("Error complining shader code, Type: "
                    + shaderType
                    + "\n"
    ...
    public void link() throws Exception {
        ...
        if (GL20.glGetProgrami(programID, GL20.GL_LINK_STATUS) == 200)
